        ...
        <>
            ...
            <div className="flex flex-wrap mx-25">
                <div className="w-[37vw] h-[55vh] overflow-hidden">
                    <img
                        src="/assets/services/servicedescription/neurology.jpg"
                ...
                <div className="w-[51%] ml-12">
                    <p className="font-bold text-2xl text-[#2B7B37]">
                        This specialty focuses on diagnosing and managing conditions that affect the brain, nerves, and nervous system.
                    </p>
                    <p className="my-6 text-l">
                        Our Neurology department provides careful evaluation and treatment for a wide range of neurological symptoms, including headaches, dizziness, weakness, numbness, memory issues, and nerve-related pain. Neurological conditions can affect daily life significantly, and our specialists ensure thorough assessments to identify the underlying cause and guide patients toward the right treatment approach.                    </p>
                    <p className="my-6 text-l font-medium">
                        We use appropriate diagnostic tools such as neurological examinations, imaging studies, blood tests, and nerve evaluations to create clear and effective treatment plans. Our team manages conditions such as migraines, nerve disorders, stroke-related issues, movement problems, seizures, and age-related neurological changes. When needed, we coordinate with other departments like cardiology, orthopedics, and general medicine for complete and connected care.                    </p>
                </div>
            </div>
            <div className="flex mt-[5vh] mx-25">
                <p className="my-6 text-l">
                    Our focus is on long-term neurological wellness through lifestyle guidance, medication management, rehabilitation support, and preventive strategies. As one of Bangalore’s dependable centers for neurological care, Happy Healthy Hospital ensures patient comfort, clarity, and continuity of care at every step.                </p>
            </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-y-3 gap-x-10 text-gray-800">
                            <ul className="space-y-3">
                                {[
                                    ...
                                    "Seizures & epilepsy",
                                    "Memory problems & age-related cognitive changes",
                                ].map((condition, index) => (
                            ...
                            <ul className="space-y-3">
                                {[
                                    "Facial nerve issues",
                                    "Numbness, tingling & limb weakness",
                                    "Movement disorders",
