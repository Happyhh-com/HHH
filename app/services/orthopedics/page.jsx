        ...
        <>
            ...
            <div className="flex flex-wrap mx-25">
                <div className="w-[37vw] h-[55vh] overflow-hidden">
                    <img
                        src="/assets/services/servicedescription/orthopedics.jpg"
                ...
                <div className="w-[51%] ml-12">
                    <p className="font-bold text-2xl text-[#2B7B37]">
                        This specialty focuses on diagnosing and treating conditions that affect bones, joints, muscles, and overall movement.
                    </p>
                    <p className="my-6 text-l">
                        Our Orthopedics department provides complete care for bone and joint problems, ranging from everyday pain to chronic musculoskeletal disorders. Whether you are dealing with back pain, joint stiffness, fractures, arthritis, or sports injuries, our specialists perform thorough evaluations and create treatment plans tailored to your daily needs and lifestyle. We focus on reducing pain, restoring movement, and improving long-term mobility.                    </p>
                    <p className="my-6 text-l font-medium">
                        We assess patients using physical examination, imaging tests (X-ray, ultrasound, MRI), and movement assessments to identify the exact cause of discomfort. Treatment may include medication, physiotherapy guidance, lifestyle modifications, fracture management, and joint care. When necessary, we collaborate closely with physiotherapists, pain specialists, and neurologists to provide connected and comprehensive care.                    </p>
                </div>
            </div>
            <div className="flex mt-[5vh] mx-25">
                <p className="my-6 text-l">
                    Our Orthopedic services emphasize long-term musculoskeletal health through posture correction, strengthening exercises, preventive care, and personalized recovery plans. As one of Bangalore’s dependable centers for joint and bone health, Happy Healthy Hospital supports patients of all ages in maintaining an active and pain-free life.                </p>
            </div>
                ...
                <div className=" flex flex-row items-center justify-between gap-10">
                    ...
                    <div className="w-full text-center lg:text-left">
                        ...
                        <h3 className="text-2xl italic font-semibold text-green-700 mb-8">
                            Under Orthopedics (Bone & Joint Care)
                        </h3>
