        ...
        <>
            ...
            <div className="flex flex-wrap mx-25">
                <div className="w-[37vw] h-[55vh] overflow-hidden">
                    <img
                        src="/assets/services/servicedescription/ent.jpg"
                ...
                <div className="w-[51%] ml-12">
                    <p className="font-bold text-2xl text-[#2B7B37]">
                        This specialty focuses on conditions affecting the ear, nose, throat, sinuses, and related structures of the head and neck.
                    </p>
                    <p className="my-6 text-l">
                        Our ENT department provides detailed evaluation and treatment for a wide range of concerns, including ear infections, hearing issues, sinus problems, allergies, throat discomfort, voice changes, and neck swellings. ENT conditions can affect breathing, sleep, speech, and daily comfort — our specialists ensure accurate diagnosis and personalised care to address the root cause of symptoms.                    </p>
                    <p className="my-6 text-l font-medium">
                        We use clinical examinations and appropriate tests such as audiometry, nasal endoscopy, throat evaluation, and imaging when needed. Treatment may include medication, allergy care, ear and sinus procedures, or minor surgical interventions. We also manage conditions such as snoring, tonsillitis, earwax blockage, vertigo, and chronic sinus infections. For complex cases, we coordinate care with neurology, ophthalmology, and general medicine to ensure holistic support.                    </p>
                </div>
            </div>
            <div className="flex mt-[5vh] mx-25">
                <p className="my-6 text-l">
                    Our ENT services aim to restore comfort, improve breathing and hearing, and provide long-term relief from recurrent issues. As one of Bangalore’s dependable centers for ENT care, Happy Healthy Hospital ensures safe, clear, and effective treatment for patients of all ages.                </p>
            </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-y-3 gap-x-10 text-gray-800">
                            <ul className="space-y-3">
                                {[
                                    ...
                                    "Allergies affecting the nose & throat",
                            ...
                            <ul className="space-y-3">
                                {[
                                    "Snoring & sleep-related breathing issues",
                                    "Vertigo, dizziness & balance problems",
                                    "Nosebleeds",
                                    "Minor head & neck swellings"
                                ].map((condition, index) => (
                                    <li key={index} className="flex items-start">
                                        <span className="inline-block w-2 h-2 bg-green-700 mt-2 mr-3 rounded-sm"></span>
                                        {condition}
