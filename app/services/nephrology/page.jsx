        ...
        <>
            ...
            <div className="flex flex-wrap mx-25">
                <div className="w-[37vw] h-[55vh] overflow-hidden">
                    <img
                        src="/assets/services/servicedescription/nephrology.jpg"
                ...
                <div className="w-[51%] ml-12">
                    <p className="font-bold text-2xl text-[#2B7B37]">
                        This specialty deals with the diagnosis, treatment, and long-term management of kidney diseases.
                    </p>
                    <p className="my-6 text-l">
                        Our Nephrology department offers comprehensive care for patients with kidney-related conditions, from early-stage concerns to advanced kidney disease. Our specialists focus on early detection, ongoing monitoring, and preventive strategies to help protect kidney function and delay disease progression. Whether it’s high blood pressure, diabetes-related kidney issues, swelling, or recurrent urinary problems, we ensure detailed evaluation and personalized care.                    </p>
                    <p className="my-6 text-l font-medium">
                        We assess kidney health using lab tests, imaging, urine studies, and kidney function monitoring. Treatment may include medication, dietary guidance, blood pressure control, diabetes management, and long-term follow-up. We also manage complex kidney conditions such as proteinuria, electrolyte imbalance, and advanced CKD. When required, we coordinate care with urology, endocrinology, and cardiology to provide complete and connected treatment.                    </p>
                </div>
            </div>
            <div className="flex mt-[5vh] mx-25">
                <p className="my-6 text-l">
                    Our nephrology services emphasize lifestyle changes, preventive health practices, and patient education to reduce complications. As one of Bangalore’s dependable centers for kidney care, Happy Healthy Hospital supports patients at every stage with clarity, compassion, and continuous monitoring.                </p>
            </div>
