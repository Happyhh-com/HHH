...
export default function NutritionDietetics() {
        ...
        <>
            ...
            <div className="flex flex-wrap mx-25">
                <div className="w-[37vw] h-[55vh] overflow-hidden">
                    <img
                        src="/assets/services/servicedescription/nutritiondietetics.jpg"
                ...
                <div className="w-[51%] ml-12">
                    <p className="font-bold text-2xl text-[#2B7B37]">
                        This specialty focuses on diet planning, nutrition therapy, and lifestyle guidance to improve overall health and manage medical conditions.
                    </p>
                    <p className="my-6 text-l">
                        Our Nutrition & Dietetics department provides personalized dietary support to help patients manage illnesses, adopt healthier habits, and work toward long-term wellness goals. Whether you need guidance for weight management, diabetes control, kidney-friendly diets, heart health, digestive issues, or general lifestyle improvement, our dietitians create practical and easy-to-follow plans suited to your needs.                    </p>
                    <p className="my-6 text-l font-medium">
                        We assess each patient’s medical history, daily routine, dietary preferences, and health goals to design balanced nutrition plans. Our services include therapeutic diets for kidney disease, diabetes, hypertension, digestive disorders, high cholesterol, and weight-related concerns. We also offer counselling on portion control, hydration, food combinations, and nutrient balance. For patients requiring long-term monitoring—such as those with CKD or chronic conditions—we provide regular follow-ups and adjustments to ensure sustained progress.                    </p>
                </div>
            </div>
            <div className="flex mt-[5vh] mx-25">
                <p className="my-6 text-l">
                    Our Nutrition & Dietetics services emphasize preventive health, sustainable eating habits, and scientifically backed dietary recommendations. As one of Bangalore’s dependable centers for nutrition care, Happy Healthy Hospital helps individuals make informed choices that support energy, healing, and overall well-being.                </p>
            </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-y-3 gap-x-10 text-gray-800">
                            <ul className="space-y-3">
                                {[
                                    ...
                                    "Kidney-friendly / low-sodium diets",
                                    "Heart-healthy diets",
                                    "Weight loss & weight gain plans",
                                    "Digestive wellness diets",
                                    "Diet for thyroid & hormonal balance",
                                ].map((condition, index) => (
                            ...
                            <ul className="space-y-3">
                                {[
                                    ...
                                    "Diet plans for anemia & vitamin deficiencies",
