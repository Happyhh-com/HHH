...
export default function ProstateCare() {
        ...
        <>
            ...
            <div className="flex flex-wrap mx-25">
                <div className="w-[37vw] h-[55vh] overflow-hidden">
                    <img
                        src="/assets/services/servicedescription/prostate_care.jpg"
                ...
                <div className="w-[51%] ml-12">
                    ...
                    <p className="my-6 text-l">
                        We offer comprehensive and advanced care for men experiencing prostate-related concerns, ranging from benign enlargement to complex urinary symptoms. Our goal is to provide early diagnosis, effective symptom relief, and long-term management with a strong focus on comfort, privacy, and personalized care. Under the supervision of experienced urologists, we evaluate each patient with detailed clinical assessment, high-precision imaging, and evidence-based treatment options to ensure accurate and timely intervention.                    </p>
                    <p className="my-6 text-l font-medium">
                        Our approach to prostate care focuses on understanding the underlying cause, whether it is benign prostatic hyperplasia (BPH), inflammation, urinary obstruction, or early signs of prostate cancer. Treatment is tailored to each individual’s condition and may include medication, lifestyle modification, minimally invasive laser procedures, or advanced surgical techniques. We use cutting-edge technologies such as laser TURP, endoscopic procedures, and high-resolution diagnostic systems to deliver safe, precise, and quicker-recovery solutions.                    </p>
                </div>
            </div>
            <div className="flex mt-[5vh] mx-25">
                <p className="my-6 text-l">
                    Our prostate care services also emphasize long-term monitoring, prevention of complications, and patient education. We help men recognize early warning signs, manage recurring symptoms, and understand prevention strategies that reduce the risk of urinary retention, infections, and kidney damage. As one of Bangalore’s trusted centers for prostate treatment, Happy Healthy Hospital ensures expert guidance and comprehensive support for every stage — from screening and diagnosis to treatment and follow-up care.                </p>
            </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-y-3 gap-x-10 text-gray-800">
                            <ul className="space-y-3">
                                {[
                                    ...
                                    "Prostate cancer (early evaluation & specialist referral)",
                            ...
                            <ul className="space-y-3">
                                {[
                                    ...
                                    "Post-void residual issues (incomplete bladder emptying)"
                                ].map((condition, index) => (
                                    <li key={index} className="flex items-start">
                                        <span className="inline-block w-2 h-2 bg-green-700 mt-2 mr-3 rounded-sm"></span>
                                        {condition}
