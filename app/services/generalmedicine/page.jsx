        ...
        <>
            ...
            <div className="flex flex-wrap mx-25">
                <div className="w-[37vw] h-[55vh] overflow-hidden">
                    <img
                        src="/assets/services/servicedescription/general_medicine.jpg"
                ...
                <div className="w-[51%] ml-12">
                    <p className="font-bold text-2xl text-[#2B7B37]">
                        This specialty deals with the diagnosis, treatment, and prevention of common medical conditions in adults.
                    </p>
                    <p className="my-6 text-l">
Our General Medicine department provides comprehensive care for everyday health needs, from routine illnesses to long-term medical conditions. Our physicians evaluate symptoms thoroughly, recommend the right tests, and create personalised treatment plans to help patients recover quickly and maintain better long-term health. Whether it's fever, infections, diabetes, thyroid issues, or digestive concerns, we ensure accurate diagnosis and reliable care.                    </p>
                    <p className="my-6 text-l font-medium">
We manage a wide range of conditions such as hypertension, respiratory infections, gastrointestinal problems, allergies, and lifestyle-related health issues. Through regular monitoring, medication guidance, and preventive care, we help patients avoid complications and stay in control of their health. When needed, our team works closely with other specialties like cardiology, nephrology, ENT, and orthopedics to ensure seamless and coordinated treatment.                    </p>
                </div>
            </div>
            <div className="flex mt-[5vh] mx-25">
                <p className="my-6 text-l">
Our focus is on early detection, preventive health check-ups, and long-term wellness. As one of Bangalore’s dependable centers for primary care, Happy Healthy Hospital is committed to providing accessible, ethical, and compassionate medical care for individuals and families.                </p>
            </div>
                    ...
                    <div className="w-full text-center lg:text-left">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-y-3 gap-x-10 text-gray-800">
                            <ul className="space-y-3">
                                {[
                                    "Fever, infections & seasonal illnesses",
                            ...
                            <ul className="space-y-3">
                                {[
                                    "Gastritis, acidity & digestive problems",
                                    "Allergies & skin infections",
                                    "Joint pains, fatigue & general weakness",
