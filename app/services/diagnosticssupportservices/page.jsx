...
export default function DiagnosticSupportServices() {
        ...
        <>
            ...
            <div className="flex flex-wrap mx-25">
                <div className="w-[37vw] h-[55vh] overflow-hidden">
                    <img
                        src="/assets/services/servicedescription/diagnostics_support.jpg"
                ...
                <div className="w-[51%] ml-12">
                    <p className="font-bold text-2xl text-[#2B7B37]">
                        This section includes essential medical facilities that support accurate diagnosis, timely treatment, and continuous patient care.
                    </p>
                    <p className="my-6 text-l">
                        Our Diagnostics & Support Services ensure that every patient receives accurate investigations, seamless treatment coordination, and round-the-clock medical assistance. These facilities play a vital role in early detection, treatment planning, emergency response, and long-term monitoring. With advanced technology and trained specialists, we provide reliable services that complement all clinical departments within the hospital.                        </p>
                    <p className="my-6 text-l font-medium">
                        We offer a wide range of diagnostic tools, including imaging, laboratory testing, endoscopic evaluations, and respiratory assessments. These services help our medical teams identify the root cause of symptoms quickly and create effective treatment plans. Alongside diagnostics, our hospital also provides essential support facilities such as dialysis care, ICU monitoring, emergency management, and a 24×7 pharmacy to ensure uninterrupted patient care.                        </p>
                </div>
            </div>
            <div className="flex mt-[5vh] mx-25">
                <p className="my-6 text-l">
                    Our focus is on accuracy, safety, and accessibility. By combining modern equipment with skilled professionals, Happy Healthy Hospital ensures that every patient receives dependable support — from diagnosis to recovery. As one of Bangalore’s dependable centers for comprehensive care, we aim to deliver clarity, comfort, and continuity at every step of your health journey.                    </p>
            </div>
