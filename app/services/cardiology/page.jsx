        ...
        <>
            ...
            <div className="flex flex-wrap mx-25">
                <div className="w-[37vw] h-[55vh] overflow-hidden">
                    <img
                        src="/assets/services/servicedescription/cardiology.jpg"
                ...
                <div className="w-[51%] ml-12">
                    <p className="font-bold text-2xl text-[#2B7B37]">
                        This specialty focuses on identifying and managing conditions that affect the heart and circulation.
                    </p>
                    <p className="my-6 text-l">
                        Our Cardiology department provides comprehensive care for a wide range of heart-related concerns, from routine evaluations to long-term management of cardiac conditions. Whether you are experiencing chest discomfort, palpitations, breathlessness, or lifestyle-related risk factors, our specialists offer thorough assessment and personalised treatment plans to support your heart health. With a strong focus on prevention, early detection, and continuous monitoring, we help patients protect and improve their cardiovascular well-being.                    </p>
                    <p className="my-6 text-l font-medium">
                        We evaluate heart health using ECG, echocardiography, cardiac blood tests, and other diagnostic tools based on symptoms and individual risk factors. Treatment may include medication, blood pressure control, cholesterol management, lifestyle changes, and coordinated care for conditions such as hypertension, arrhythmias, and heart failure. When required, our team works closely with other specialties to ensure complete and connected care.                    </p>
                </div>
            </div>
            <div className="flex mt-[5vh] mx-25">
                <p className="my-6 text-l">
                    Our Cardiology services emphasize long-term wellness through regular follow-ups, heart-health risk assessments, diet guidance, and preventive strategies. As one of Bangalore’s dependable centers for heart care, Happy Healthy Hospital is committed to helping individuals maintain strong and healthy hearts at every stage of life.                </p>
            </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-y-3 gap-x-10 text-gray-800">
                            <ul className="space-y-3">
                                {[
                                    ...
                                    "Shortness of breath",
                                    "Early heart failure management",
                                ].map((condition, index) => (
                            ...
                            <ul className="space-y-3">
                                {[
                                    "Diabetic-related heart risks",
                                    "Swelling due to heart-related fluid retention",
                                    "Lifestyle-related heart disease",
