...
export default function SwathiDescription() {
  ...
  return (
    <div className="px-6 md:px-10 py-10">
      <div className="flex flex-wrap items-center space-x-2 font-semibold text-gray-400 mb-6 text-sm md:text-base">
        ...
        <span>/</span>
        <span className="text-green-600">Dr. Swathi R. K </span>
      </div>
      ...
      <Section title="Area of Expertise">
        <ul className="list-disc ml-6 text-gray-700 space-y-1">
          ...
          <li>Direct Laryngoscopy </li>
          <li>Otomicroscopy</li>
          <li>Intratympanic Injections</li>
          <li>Minor ENT Procedures </li>
          <li>Adenoidectomy & Tonsillectomy</li>
          <li>Septoplasty / SMR / FESS</li>
          <li>Myringotomy & Grommet Insertion</li>
          <li>Tympanoplasty</li>
          <li>Mastoidectomy</li>
