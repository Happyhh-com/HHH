...
export default function MahanteshDescription() {
  ...
  return (
    <div className="px-6 md:px-10 py-10">
      <div className="flex flex-wrap items-center space-x-2 font-semibold text-gray-400 mb-6 text-sm md:text-base">
        ...
        <span>/</span>
        <span className="text-green-600">Dr. Mahantesh R. Charantimath </span>
      </div>
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-10 mb-10">
        ...
        <div className="flex flex-col space-y-3 text-center md:text-left">
          ...
          <p className="text-gray-700 font-medium text-sm md:text-base">
            MBBS, MD – General Medicine, DM – Cardiology, FESC (Fellow of
            European Society of Cardiology)
          </p>
          <p className="text-blue-600 font-semibold text-sm md:text-base">
            Interventional Cardiologist & Cardiologist • 31 Years of Overall
            Experience (22 years as a Cardiology Specialist)
          </p>
          <button
      ...
      <Section title="Overview">
        <p>
          Dr. Mahantesh R. Charantimath is a highly experienced Interventional
          Cardiologist with more than three decades of clinical experience,
          including over 22 years specialising in advanced cardiac care. His
          expertise covers coronary angiographies, angioplasty procedures,
          stenting, and complex cardiovascular interventions. He is skilled in
          managing acute cardiac emergencies, structural heart defects, rhythm
          disorders, and interventional cardiology procedures. He is recognised
          for his precision in diagnosing heart conditions and delivering
          evidence-based cardiac treatments with a patient-focused approach.
        </p>
      </Section>
      ...
      <Section title="Area of Expertise">
        <ul className="list-disc ml-6 text-gray-700 space-y-1">
          ...
          <li>Primary Angioplasty for Acute Heart Attack</li>
          <li>ICD & Pacemaker Implantation </li>
          <li>Valvuloplasty</li>
          <li>Device Closure for structural heart defects (ASD, PDA, VSD)</li>
          <li>Renal & Carotid Interventions</li>
          <li>Management of Acute Heart Attack</li>
          <li>Critical Cardiac Care & Emergency Cardiology</li>
        ...
        <Card>
          <div className="ml-0 sm:ml-6 w-full">
            ...
            <p className="text-xl md:text-2xl font-semibold text-gray-900 leading-snug mt-1">
              31 Years of Overall Experience (22 years as a Cardiology
              Specialist)
            </p>
          </div>
        </Card>
        ...
        <Card>
          <div className="ml-0 sm:ml-6 w-full">
            ...
            <ul className="list-disc ml-5 text-gray-800 space-y-1 text-sm md:text-base">
              ...
              <li>DM – Cardiology</li>
              <li>FESC (Fellow of European Society of Cardiology)</li>
            </ul>
          </div>
        </Card>
